...
import * as TableModifiedHeaderStories from './table.modified.header.stories';

<Meta name='Modified Header Functions' of={TableModifiedHeaderStories} />
...
<Canvas of={TableModifiedHeaderStories.ModifiedHeaderFn} />
